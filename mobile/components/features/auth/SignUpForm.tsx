	...
	return (
		<Fragment>
			...
			>
                ...
                <Checkbox
                    label={<Text>Ich habe die <Text fw="bold" c="blue" onPress={() => Linking.openURL("https://univocal.de/service/nutzungsbedingungen")}>Nutzungsbedingungen</Text> gelesen und stimme diesen zu.</Text> as unknown as string}
                    checked={terms}
