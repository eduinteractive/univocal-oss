...
app.use("/api/knowledge/tenant/:tenantId", currentUser, requireAuth, requireTenant, TenantRouter);
app.use("/api/knowledge/network", isK8s, NetworkRouter);

app.use(errorHandler);

createSVHService(app, {
    serverPort: 3006,
    database: "uvc-knowledge",
