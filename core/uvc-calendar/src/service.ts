...
app.use("/api/calendar/public", PublicRouter)
app.use("/api/calendar/tenant/:tenantId", currentUser, requireAuth, requireTenant, TenantRouter);
app.use("/api/calendar/network", isK8s, NetworkRouter);
